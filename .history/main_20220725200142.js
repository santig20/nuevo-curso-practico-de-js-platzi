...
//const escuchar = boton.addEventListener('click',btnonclick);

// creamos la variable y agregamos un escuchador de eventos al form

const form = document.getElementById("form");

const escuchar= form.addEventListener('submit',btnonclick, preve)